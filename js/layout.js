...
function renderLayout() {
  const headerHtml = `
    <header class="app-header">
      <div class="navbar-top" style="display: flex; justify-content: space-between; align-items: center; padding-right: 20px; background: white; border-bottom: 1px solid #eee;">
        <button class="mobile-menu-btn" onclick="toggleSidebar()" style="background: var(--primary-color); color: white; padding: 10px 20px; border-radius: 4px; font-weight: 900; font-size: 1.1rem; margin: 10px; display: flex; align-items: center; gap: 8px; border: none; cursor: pointer;">
